def is_even(getal:int) -> bool:
    return getal % 2 == 0 # Deze functie geeft aan de hand van een True/False value aan of het getal even is of oneven.
...
def string_changer(woord_zin:str) -> str:
    ...
    return omgekeerde_string # Resultaat wordt getoond.
...
def string_lengte(gegeven_woord:str) -> int: # Deze functie geeft aan hoeveel unieke letters in een string zitten.
    ...
    return aantal_soorten_letters # Aantal letters wordt getoond.
...
def gemiddelde_letter(woord_of_zin:str) -> float:
    ...
    return letters_per_woord # Deze return laat zien hoeveel letters ieder woord gemiddeld krijgt.
...
print(is_even(2))
print(string_changer("Hallo ik ben Yilmaz"))

print(string_lengte("Hallo wereld"))
print(gemiddelde_letter("Dit is een voorbeeldzin"))
tafel_van(50)